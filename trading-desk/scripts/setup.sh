...
python -m py_compile scripts/run_desk_analysis.py scripts/scan_watchlist.py scripts/options_signal_scanner.py scripts/openalice_bridge.py bot/discord_bot.py ui/dashboard.py
