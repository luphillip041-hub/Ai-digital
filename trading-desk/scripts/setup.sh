...
python -m py_compile scripts/run_desk_analysis.py scripts/scan_watchlist.py scripts/openalice_bridge.py bot/discord_bot.py desk_agents/llm.py desk_agents/subagent.py desk_agents/marketdata.py desk_agents/orchestrator.py
